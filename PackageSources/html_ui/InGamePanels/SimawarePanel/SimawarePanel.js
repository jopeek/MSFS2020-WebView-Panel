class IngamePanelSimawarePanel extends TemplateElement {
    constructor() {
        super(...arguments);
    ...
    connectedCallback() {
        ...
        this.iframeElement = document.getElementById("SimawarePanelIframe");
...
window.customElements.define("ingamepanel-custom", IngamePanelSimawarePanel);
checkAutoload();
